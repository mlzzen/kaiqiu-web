  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'set-score/group/:eventid/:itemid', name: 'set-score-group', component: () => import('../views/SetScoreGroupView.vue'), meta: { title: '小组赛比分录入' } },
        { path: 'set-score/tt/:eventid/:itemid', name: 'set-score-tt', component: () => import('../views/SetScoreTtView.vue'), meta: { title: '淘汰赛比分录入' } },
